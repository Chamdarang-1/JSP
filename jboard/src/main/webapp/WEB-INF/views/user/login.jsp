...
<body>
    <div id="wrapper">
            ...
            <section class="login">
                ...
                <div>
                    ...
                    <div style="text-align: right;">
                        <a href="/jboard/find/userId.html">아이디 |</a>
                        <a href="/jboard/find/password.html">비밀번호찾기 |</a>
                        <a href="/jboard/terms.html">회원가입</a>
                    </div>                    
                </div>
            </section>
        </main>
        <footer>
            <p>
                <span class="copyright">Copy	rightⓒ 김철학(개발에반하다.)</span>
