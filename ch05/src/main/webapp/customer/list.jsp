...
<%
	...
	try{
		...
		// jdbc/joseph8034 커넥션풀 검색 datasource = 커넥션 풀
		...
		<table border ="1">
			...
			<tr>
				...
				<td>
					...
					<a href = "/ch05/customer/modify.jsp?user_id="<%= customer.getCid()%>>수정</a>
					<a href = "/ch05/customer/delete.jsp?user_id=<%= customer.getCid()%>">삭제</a>
				</td>
			</tr>	
			<% } %>
		</table>
